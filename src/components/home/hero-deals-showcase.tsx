  ...
  const deals: PromoDeal[] = [
    {
      ...
      couponCode: 'BLACK90',
      featureBenefit: '90% OFF Clearance Voucher',
      featureIcon: Tag,
    ...
    },
    {
      ...
      title: 'Secret Discount Coupons',
      highlight: '20% OFF Voucher',
      description: 'Instant student discounts on phones, tech repairs, graphic design & salon appointments.',
      couponCode: 'CAMPUS20',
      featureBenefit: '20% OFF Campus Discount Coupon',
      featureIcon: Tag,
      ctaText: 'Explore Voucher Store',
      ctaHref: '/deals',
      icon: VoucherBoxIcon,
    ...
    },
    {
      ...
      featureBenefit: 'Official Community • 2,500+ Verified Students',
      featureIcon: Users,
    ...
    },
    {
      ...
      highlight: 'Call / Chat Order',
      description: 'Need help placing an order or finding verified student sellers? Reach the direct campus help desk.',
      featureBenefit: 'Direct Campus Desk • 0% Agent Commission',
      featureIcon: PhoneCall,
      ctaText: 'Connect on WhatsApp',
      ctaHref: 'https://wa.me/2348000000000?text=Hello%20CUSTECH%20Marketplace%20Support%2C%20I%20want%20to%20place%20an%20order',
